        ...
        if (![self isCancelled]) {
            ...
            dispatch_async([self.class _imageQueue], ^{
                ...
                if (allowAnimation) {
                    ...
                    if ([image isKindOfClass:[YYImage class]] && [image conformsToProtocol:@protocol(YYAnimatedImage)]) {
                        YYImage *newImage = (YYImage *)image;
                        if ([newImage animatedImageFrameCount] > 1) {
                            hasAnimation = YES;
                        }
                    }
                } else {
